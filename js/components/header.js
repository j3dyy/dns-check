    ...
    <header class="site-header">
      <div class="container site-header-inner">
        ...
        <div class="header-actions">
          <button class="text-btn" id="btn-cli-modal" title="View CLI dig &amp; nslookup commands">
            ${icons.terminal(16)}
            <span>CLI Dig</span>
          </button>
          
          <button class="icon-btn" id="btn-share-url" title="Share or Copy Link">
            ${icons.share(16)}
          </button>
          ...
          <a href="https://github.com/j3dyy/dns-usectl" target="_blank" rel="noopener" class="icon-btn" title="GitHub Repository">
